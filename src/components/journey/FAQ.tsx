...
const perguntas = [
  ...
  },
  {
    ...
    a: "Sim! Princesas, heróis (Homem-Aranha, Cavaleiro das Sombras, Heróis do Pijama), mascotes, personagens do K-Pop, do universo pop e brasileiros (Maria Bonita, Casal da Roça). Veja todos em 'Mundos'.",
  },
  {
